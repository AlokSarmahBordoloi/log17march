    ...
    <div class="container">
        ...
        <form action="registration.php" method="post">
            ...
            <label for="cars">Choose a car:</label>
                ...
                <option value="volvo">AS01R4456</option>
                <option value="saab">AS01R4457</option>
                 <option value="fiat">AS01R4489</option>
                <option value="audi">AS01R4457</option>
                <option value="audi">AS01D4957</option>
                <option value="audi">AS01E7450</option>
                <option value="audi">AS03Q6322</option>
                <option value="audi">AS03P9812</option>
                <option value="audi">AS03R4471</option>
                <option value="audi">AS03R4422</option>
                <option value="audi">AS03R1217</option>
                <option value="audi">AS03R8857</option>
                </select>
            </div>
